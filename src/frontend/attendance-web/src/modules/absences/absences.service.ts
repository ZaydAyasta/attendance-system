...
export async function listMyAbsences(filters: Omit<AbsenceFilters, 'employeeId'>): Promise<Absence[]> { return (await apiClient.get<Absence[]>('/me/absences', { params: filters })).data }
